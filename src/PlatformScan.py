...
def start_platform_scan(scan_configuration: ScanConfiguration):
    scan_command = ["java", "-jar", scan_configuration.veracode_wrapper_location, "-appid", scan_configuration.application_legacy_id, "-vid", scan_configuration.vid, "-vkey", scan_configuration.vkey, "-action", 
                  "uploadandscanbyappid", "-createsandbox", "true", "-filepath", scan_configuration.source, "-version", scan_configuration.version]
