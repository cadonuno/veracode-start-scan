...
from ScanConfiguration import ScanConfiguration, CustomField

def try_to_run_and_return(input_parameter: str, function_to_run, scan_configuration: ScanConfiguration):
    try:
        return function_to_run(input_parameter)
    except Exception as e:
        exit_with_error(e, -1, scan_configuration)

def get_business_unit_id(business_unit_name: str, scan_configuration: ScanConfiguration):
...
def get_application_id(application_name: str, scan_configuration: ScanConfiguration):
...
def get_application_policy_name(application_guid: str, scan_configuration: ScanConfiguration):
...
def get_collection_id(collection_name: str, scan_configuration: ScanConfiguration):
...
def get_team_id(team_name: str, scan_configuration: ScanConfiguration):
...
def create_team(team_name: str, scan_configuration: ScanConfiguration):
...
def create_business_unit(scan_configuration: ScanConfiguration):
    return try_to_run_and_return(scan_configuration, inner_create_business_unit, scan_configuration)

def inner_create_business_unit(scan_configuration: ScanConfiguration):
    business_unit = BusinessUnits.create(scan_configuration.business_unit, map(scan_configuration.teams, lambda team: team.guid))
    return business_unit["bu_id"]

def create_application(scan_configuration: ScanConfiguration):
    return try_to_run_and_return(scan_configuration, inner_create_application, scan_configuration)

def parse_custom_field(custom_field: CustomField):
    return {
        "name": custom_field.name,
        "value": custom_field.value
    }

def inner_create_application(scan_configuration: ScanConfiguration):
    application = Applications.create(app_name=scan_configuration.application, business_criticality=scan_configuration.business_criticality,
                        business_unit=scan_configuration.business_unit_guid, teams=map(scan_configuration.teams, lambda team: team.guid),
                        custom_fields=map(scan_configuration.application_custom_fields, lambda custom_field: parse_custom_field(custom_field)), 
...
def create_collection(scan_configuration: ScanConfiguration):
    return try_to_run_and_return(scan_configuration, inner_create_collection, scan_configuration)

def inner_create_collection(scan_configuration: ScanConfiguration):
...
def update_collection(scan_configuration: ScanConfiguration):
    return try_to_run_and_return(scan_configuration, inner_update_collection, scan_configuration)

def inner_update_collection(scan_configuration: ScanConfiguration):
