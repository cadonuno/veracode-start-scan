...
def start_platform_scan(scan_configuration: ScanConfiguration):
    scan_command = ["java", "-jar", "./VeracodeJavaAPI", "-appname", scan_configuration.application, "-vid", scan_configuration.vid, "-vkey", scan_configuration.vkey, "-action", 
                  "uploadandscan", "-createprofile", "true", "-filepath", scan_configuration.source, "-version", scan_configuration.version]
    ...
    call_subprocess(scan_configuration, scan_command)
