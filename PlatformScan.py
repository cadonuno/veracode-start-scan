...
def start_platform_scan(scan_configuration: ScanConfiguration):
    scan_command = ["java", "-jar", "./VeracodeJavaAPI.jar", "-appname", scan_configuration.application, "-vid", scan_configuration.vid, "-vkey", scan_configuration.vkey, "-action", 
    ...
    call_subprocess(scan_configuration, scan_configuration.fail_build, scan_command)
